...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AltaEncargados
     * @param controlUsu 
     */
    public AltaEmpleado(VentanaPrincipal v, ControlUsuarios controlUsu) {
    ...
    private void initComponents() {
        ...
        altaEncargadosLabel.setText("ALTA EMPLEADOS");
        ...
        try {
			try {
				...
				try {
					...
					Empleado emp = new Empleado(nombre, apellidos, DNI, contraseña, correo, telefono);
					this.control.altaEmpleado(emp);
					JOptionPane.showMessageDialog(this,
							"Se ha dado de alta al empleado correctamente",
							"Éxito",
